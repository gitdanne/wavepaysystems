    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          ...
          <div className="glass-panel" style={{ padding: 20, marginBottom: 16 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              ...
              <div>
                ...
                <input type="number" className="input-field" placeholder="0 ₸" value={amount} onChange={e => setAmount(e.target.value)} style={{ fontSize: 20, fontWeight: 600, textAlign: 'center' }} />
              </div>
      ...
      {done && (
        <div className="glass-panel" style={{ textAlign: 'center', padding: '40px 24px', animation: 'slideDown 0.3s ease-out' }}>
          ...
          <p style={{ fontSize: 14, color: 'var(--text-secondary)' }}>{selected?.name} — {amount} ₸</p>
        </div>
      )}
    </div>
  );
